...
})(EFunctionKey = exports.EFunctionKey || (exports.EFunctionKey = {}));
exports.reducers = {
...
// dva参数
const dvaParams = { storeInstance: null, printLog: false, token: "Token" };
// 所有的model
const modelArray = [];
...
const initModels = (printLog = false, token = "Token") => {
